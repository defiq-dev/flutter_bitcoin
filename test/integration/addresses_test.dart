...
import 'package:flutter_bitcoin/src/payments/p2pkh.dart' show P2PKH;
...
main() {
  group('bitcoinjs-lib (addresses)', () {
    ...
    test('can generate a Litecoin address', () {
      ...
      final wif = keyPair.toWIF();
      final address = P2PKH(data: PaymentData(pubkey: keyPair.publicKey), network: litecoin).data.address;
    ...
    test('can generate a SegWit address', () {
      ...
      final address = P2WPKH(data: PaymentData(pubkey: keyPair.publicKey)).data.address;
    ...
    test('can generate a SegWit testnet address', () {
      ...
      final address = P2WPKH(data: PaymentData(pubkey: keyPair.publicKey), network: testnet).data.address;
